...
extern void trigger_bits_set(u16 param1);
extern void trigger_bits_toggle(u16 param1);
extern void trigger_tex_load(u16 param1);
extern void trigger_tex_free(u16 param1);
