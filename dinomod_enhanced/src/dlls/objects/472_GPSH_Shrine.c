...
RECOMP_PATCH void GPSH_Shrine_control(Object* self) {
    ...
    if (objdata->unk2 > 0) {
        ...
        case 5:
            ...
            // @recomp: Set Warlock Mountain setup
            //main_set_bits(BIT_WM_Map_Setup, 8); // TODO: this isn't needed?
            gDLL_29_Gplay->vtbl->set_map_setup(MAP_WARLOCK_MOUNTAIN, 8);
            // @recomp: Clear bit 0x5AD
...
RECOMP_PATCH int GPSH_Shrine_func_1024(Object* a0, Object* a1, AnimObj_Data* a2, void* a3) {
    GPSH_Shrine_Data* objdata;
    Object* player;
    s32 i;
    u8 temp_v0_2;
