...
RECOMP_HOOK_DLL(gplay_ctor) void gplay_patch_map_object_group_flags() {
    data_F0[MAP_EARTHWALKER_TEMPLE] = 0x36a; //Shares Walled City's flag
    data_F0[MAP_BOSS_KAMERIAN_DRAGON] = 0x5dc; //Shares the same flag as the rest of Dragon Rock (Bottom)
}
